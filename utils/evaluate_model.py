...
def evaluate_model(estimator: automlx._interface.classifier.AutoClassifier, X_test: pd.DataFrame, y_test: pd.Series, print_confusion_matrix: bool = True) -> None: # type: ignore
    '''
